% Logan Prust - Aer E 311 - Homework 3 - Problem 2
...
sigma_initial=mu+1; % sets initial values to start search

n=1; % initializes the iteration counter
error=1; % sets some arbitrary initial value for the error
sigma=sigma_initial; % sets sigma equal to one of its initial values
while error>=epsilon
...
% get and output final sigma value
sigmafinal=sigma;
